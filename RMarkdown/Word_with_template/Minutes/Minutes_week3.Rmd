---
title: "Minutes of the Week 3 Meeting"
author: "Team 10"
date: "18/03/2022"
output: 
  word_document:
...
**Chair**&emsp;&emsp;&emsp;&ensp;Student 3 
...
# Time and Place
The $2^{nd}$ client meeting was held on Monday 18/03/2022 online at 11:30AM.

# Quorum Announcement
The Chairman announced that a quorum of the group was present, and that the meeting, having been duly convened, was ready to proceed with its business. MS Teams was used as a real-time communication platform supplemented by Azure DevOps.
...
3. Discuss how the model is used by our team project:
    ...
    - Out team recommended to use model provision and mechanism with parameters. A collection of parameters needs to be provided by client through JSON which will be used in our provision. Models will also use that parameter collection as a part of usage.
...
6. Discussed the way of collaborative:
    - Stand-alone is the preference.
...
* Assisted chairperson student as a secretary.
...
## Student3
* Updated SRS, Minutes, Agenda documents.
* Built and updated dedicated pitch presentation slides.
...
* GraphQL demonstrates benefits over REST.

# Adjournment
The client meeting 2 was closed at 13:00 PM. 

The next client meetings scheduled as below:

* 22/03/2022 at 09:30AM - 10:30PM (Zoom with HeartAI CEO)
